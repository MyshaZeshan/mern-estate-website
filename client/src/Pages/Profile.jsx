  ...
  return (
    <section  className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col items-center gap-4 bg-[rgb(250,243,225)] p-8 rounded-lg shadow-md max-w-md mx-auto'>
        ...
        <input type='text' placeholder='username' id='username' className='border border-gray-300 p-2 rounded-lg w-full text-center' />
        <input type='email' placeholder='email' className='border border-gray-300 p-2 rounded-lg w-full text-center' id='email' />
