...
const UpdateListing = () => {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto '>
        <h1 className='text-3xl font-extrabold text-center my-7'>Update Listing</h1>
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row bg-[rgb(250,243,225)] p-8 rounded-lg shadow-md'>
            ...
            <div className='flex flex-col flex-1 gap-4 ml-3'>
                ...
                <button  className='text-[rgb(250,243,225)] bg-[rgb(255,109,31)] font-extrabold p-2 border rounded-lg  hover:opacity-95 disabled:opacity-80 uppercase w-full'>{loading?'loading':'update listing'}</button>
